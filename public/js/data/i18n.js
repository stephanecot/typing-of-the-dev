  ...
  fr: {
    ...
    releaseNotes: [
      ['v1.3.0', [
        ...
        'Invite CODE SECRET (touche C, Konami compris) : gines, disco (ambiance + musique), boisson (écran qui tangue), speed (+30 %), iddqd',
      ...
      ['v1.2.0', [
        ...
        'Des codes secrets se cachent derrière la touche C de l\'accueil (un prénom, une danse, une boisson de trop, un classique de DOOM…)',
      ]],
      ['v1.1.0', [
  ...
  en: {
    ...
    releaseNotes: [
      ['v1.3.0', [
        ...
        'SECRET CODE prompt (C key, Konami included): gines, disco (ambiance + music), boisson (wobbly screen), speed (+30%), iddqd',
      ...
      ['v1.2.0', [
        ...
        'Secret codes hide behind the C key on the home screen (a first name, a dance, one drink too many, a DOOM classic…)',
      ]],
      ['v1.1.0', [
