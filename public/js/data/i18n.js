...
const I18N = {
  fr: {
    ...
    bestiaryBossesInf: [
      ...
      ['framework', 'LE FRAMEWORK DU JOUR', 'À chaque coup il pivote : la\ncommande suivante change.\nDéjà obsolète.'],
      ['certificat', 'LE CERTIFICAT EXPIRÉ', 'Rapide, une commande de moins…\nmais 3 vies s\'il touche la prod.\nRenouvelez-le !'],
      ['audit', 'L\'AUDIT SURPRISE', 'Chaque commande encaissée\nconvoque un consultant.\nTout est facturable.'],
      ['facture', 'LA FACTURE CLOUD', 'Chaque coup encaissé vous\ncoûte 150 points.\nLe cloud, c\'est pas gratuit.'],
    ],
    ...
    bossFramework: 'LE FRAMEWORK DU JOUR',
    bossCertificat: 'LE CERTIFICAT EXPIRÉ',
    bossAudit: 'L\'AUDIT SURPRISE',
    bossFacture: 'LA FACTURE CLOUD',
  ...
  en: {
    ...
    bestiaryBossesInf: [
      ...
      ['framework', 'THE FRAMEWORK OF THE DAY', 'Pivots on every hit: the next\ncommand changes.\nAlready obsolete.'],
      ['certificat', 'THE EXPIRED CERTIFICATE', 'Fast, one command less… but\ncosts 3 lives if it reaches\nprod. Renew it!'],
      ['audit', 'THE SURPRISE AUDIT', 'Every command it takes\nsummons a consultant.\nEverything is billable.'],
      ['facture', 'THE CLOUD BILL', 'Every hit it takes costs\nyou 150 points.\nThe cloud is not free.'],
    ],
    ...
    bossFramework: 'THE FRAMEWORK OF THE DAY',
    bossCertificat: 'THE EXPIRED CERTIFICATE',
    bossAudit: 'THE SURPRISE AUDIT',
    bossFacture: 'THE CLOUD BILL',
